...
/// next to the tests. The apphost is what an executable resolver finds on a search path; the dll is what a test
/// starts through <c>dotnet</c> when it wants no apphost in the way.
/// </summary>
