...
public class CampaignServiceTests
{
    ...
    public async Task Renaming_a_campaign_journals_the_old_and_the_new_name()
    {
        ...
        var renamed = await service.UpdateAsync(new CampaignUpdateRequest(created.Id, Optional<string?>.Of("EMEA"), null, "narrowed the region"), Ct);
    ...
    public async Task An_update_that_changes_nothing_writes_nothing()
    {
        ...
        var absent = await service.UpdateAsync(new CampaignUpdateRequest(created.Id, Optional<string?>.Absent, null, null), Ct);
        var same = await service.UpdateAsync(new CampaignUpdateRequest(created.Id, Optional<string?>.Of("LatAm"), null, null), Ct);
    ...
    public async Task A_name_cannot_be_cleared_by_patching_it_to_null()
    {
        ...
        var error = await Assert.ThrowsAsync<ValidationException>(
            () => service.UpdateAsync(new CampaignUpdateRequest(created.Id, Optional<string?>.Of(null), null, null), Ct));
