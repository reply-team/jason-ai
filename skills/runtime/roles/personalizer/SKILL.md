...
the contact record holds that person's own data and is not a place to park drafts about them. You send nothing,
and the wording you produce reaches a person only through a provider operation on another work item.
